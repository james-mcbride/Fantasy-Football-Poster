...
function Qb({quarterBack}) {
    const qbJerseyLeftPosition = quarterBack.number > 10 ? "139px" : "148px"
    const height =300;
    const width = 300;
    const left = 0
    const top = 200
    ...
    return (
        <div style={{position: "absolute", height: height, width: width, left: left, top: top}}>
            <div style={{position: "relative", width: "fit-content", float: "left"}} className={quarterBack.team}>
                {/*<div id="qb-logo">*/}
                {/*    <img src={require(`../img/${quarterBack.team}.svg`)} />*/}
                {/*</div>*/}
                <div id="qb-jersey-number" style={{left: qbJerseyLeftPosition}}>
                    {quarterBack.number}
                </div>
                <div className="player-name" style={{left: 100, top: -5}}>
                    {quarterBack.name}
                </div>
                <svg
                    version="1.0"
                ...
                >
                    ...
                    <g
                        id="g537"
                        transform="matrix(2.4984776,0,0,2.270444,-809.58173,19.297447)">
                        <g
                            id="g331">
                            <g
                                id="g287">
                        ...
                        <g
                            ...
                            <path
                                ...
                                clip-rule="evenodd"
                                className="color_1"
                                d="m 507.80149,93.301951 c -1.11,5.245 -8.86749,14.370049 -10.23349,19.160049 -0.70984,-5.57849 0.4956,-11.96945 1.13041,-15.896591 2.89857,-15.809787 7.15361,-7.774652 9.10308,-3.263458 z"
                                id="path523"
                            />
                            <path
                                fill-rule="evenodd"
